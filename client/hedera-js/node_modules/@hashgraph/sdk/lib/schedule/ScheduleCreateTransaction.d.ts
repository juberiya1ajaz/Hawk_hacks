...
export default class ScheduleCreateTransaction extends Transaction {
     ...
     */
    static _fromProtobuf(transactions: HashgraphProto.proto.ITransaction[], signedTransactions: HashgraphProto.proto.ISignedTransaction[], transactionIds: TransactionId[], nodeIds: AccountId[], bodies: HashgraphProto.proto.ITransactionBody[]): ScheduleCreateTransaction;
    /**
     * @param {object} [props]
     ...
     */
    protected override _makeTransactionData(): HashgraphProto.proto.IScheduleCreateTransactionBody;
}
export namespace HashgraphProto {
    namespace proto {
        ...
        type IScheduleCreateTransactionBody = import("@hashgraph/proto").proto.IScheduleCreateTransactionBody;
