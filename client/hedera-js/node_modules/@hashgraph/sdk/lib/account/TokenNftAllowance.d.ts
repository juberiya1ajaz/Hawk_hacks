...
export default class TokenNftAllowance {
     ...
     */
    static _fromProtobuf(allowance: HashgraphProto.proto.INftAllowance): TokenNftAllowance;
    /**
     * @internal
     ...
     * @returns {TokenNftAllowance}
     */
    static _fromGrantedProtobuf(allowance: HashgraphProto.proto.IGrantedNftAllowance, ownerAccountId: AccountId): TokenNftAllowance;
    /**
     * @internal
     * @param {HashgraphProto.proto.INftRemoveAllowance} allowance
     * @returns {TokenNftAllowance}
     */
    static _fromRemoveProtobuf(allowance: HashgraphProto.proto.INftRemoveAllowance): TokenNftAllowance;
    /**
     * @internal
     * @param {object} props
     ...
     */
    _toProtobuf(): HashgraphProto.proto.INftAllowance;
    /**
     * @param {Client} client
     */
