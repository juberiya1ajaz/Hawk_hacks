...
export default class Channel {
     ...
     */
    protected _crypto: HashgraphProto.proto.CryptoService | null;
    /**
     * @protected
     * @type {?HashgraphProto.proto.SmartContractService}
     */
    protected _smartContract: HashgraphProto.proto.SmartContractService | null;
    /**
     * @protected
     * @type {?HashgraphProto.proto.FileService}
     */
    protected _file: HashgraphProto.proto.FileService | null;
    /**
     * @protected
     * @type {?HashgraphProto.proto.ConsensusService}
     */
    protected _consensus: HashgraphProto.proto.ConsensusService | null;
    /**
     * @protected
     * @type {?HashgraphProto.proto.FreezeService}
     */
    protected _freeze: HashgraphProto.proto.FreezeService | null;
    /**
     * @protected
     * @type {?HashgraphProto.proto.NetworkService}
     */
    protected _network: HashgraphProto.proto.NetworkService | null;
    /**
     * @protected
     * @type {?HashgraphProto.proto.TokenService}
     */
    protected _token: HashgraphProto.proto.TokenService | null;
    /**
     * @protected
     * @type {?HashgraphProto.proto.ScheduleService}
     */
    protected _schedule: HashgraphProto.proto.ScheduleService | null;
    /**
     * @abstract
     * @returns {void}
     */
     ...
     */
    get crypto(): HashgraphProto.proto.CryptoService;
    /**
     * @returns {HashgraphProto.proto.SmartContractService}
     */
    get smartContract(): HashgraphProto.proto.SmartContractService;
    /**
     * @returns {HashgraphProto.proto.FileService}
     */
    get file(): HashgraphProto.proto.FileService;
    /**
     * @returns {HashgraphProto.proto.ConsensusService}
     */
    get consensus(): HashgraphProto.proto.ConsensusService;
    /**
     * @returns {HashgraphProto.proto.FreezeService}
     */
    get freeze(): HashgraphProto.proto.FreezeService;
    /**
     ...
     */
    get token(): HashgraphProto.proto.TokenService;
    /**
     * @returns {HashgraphProto.proto.ScheduleService}
     */
    get schedule(): HashgraphProto.proto.ScheduleService;
    /**
     * @abstract
     * @protected
