...
declare namespace Status {
    ...
    const InvalidAllowanceOwnerId: Status;
    const InvalidAllowanceSpenderId: Status;
    const RepeatedAllowancesToDelete: Status;
    const InvalidDelegatingSpender: Status;
    const DelegatingSpenderCannotGrantApproveForAll: Status;
    const DelegatingSpenderDoesNotHaveApproveForAll: Status;
    const ScheduleExpirationTimeTooFarInFuture: Status;
    const ScheduleExpirationTimeMustBeHigherThanConsensusTime: Status;
    const ScheduleFutureThrottleExceeded: Status;
    const ScheduleFutureGasLimitExceeded: Status;
    const InvalidEthereumTransaction: Status;
    const WrongChainId: Status;
    const WrongNonce: Status;
    const AccessListUnsupported: Status;
}
