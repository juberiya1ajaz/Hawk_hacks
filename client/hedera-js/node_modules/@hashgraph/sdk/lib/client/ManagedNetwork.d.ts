 ...
 */
export default class ManagedNetwork<ChannelT extends import("../channel/Channel.js").default | import("../channel/MirrorChannel.js").default, NetworkNodeT extends import("../ManagedNode.js").default<ChannelT>, KeyT extends {
    toString: () => string;
}> {
    /**
